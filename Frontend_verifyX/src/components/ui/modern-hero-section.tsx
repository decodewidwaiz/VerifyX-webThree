...
export default function HeroGeometric({
  badge = "VerifyX Protocol",
  title1 = "The Trust Layer for",
  title2 = "Academic Integrity",
}: {
  badge?: string
  title1?: string
  title2?: string
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-white/60 tracking-wide uppercase font-bold">{badge}</span>
          </motion.div>

          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight font-sreda">
              ...
              >
                {title2.includes('Academic') ? (
                  <>
                    {title2.split('Academic')[0]}
                    <span className="font-pacifico font-normal tracking-normal">Academic</span>
                    {title2.split('Academic')[1]}
                  </>
                ) : (
                  title2
                )}
          ...
          >
            ...
            <Link href="/auth">
              <button className="px-8 py-4 rounded-full bg-primary text-primary-foreground font-bold text-sm tracking-widest uppercase transition-all duration-300 hover:bg-primary/90 shadow-[0_0_20px_rgba(61,163,255,0.3)] min-w-[200px] flex items-center justify-center gap-2">
                Get Started
